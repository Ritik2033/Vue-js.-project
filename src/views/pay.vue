            ...
            <div class="row">
                <div class="transfer">
                    <div class="col-xl-12 col-xxl-6 col-sm-6">
                        <div class="card bg-primary" style="background-color: #1EAAE7 !important; margin: 2%; border: none !important;">
                    ...
                    <div class="col-xl-12 col-xxl-6 col-sm-6" >
                        <div class="card bg-success" style="background-color:  #2BC155 !important; margin: 2%; border: none !important;" >
                            <div class="card-body p-3">
                                <div class="d-flex align-items-center">
                                    <span class="bg-white rounded-circle p-3 me-4">
                                        <svg width="28" height="28" viewBox="0 0 28 28" fill="none"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex pb-3 border-bottom mb-3 align-items-center">
                                <img src="../assets/10.png" alt="" class="rounded-circle me-3" width="50">
                                <div class="me-auto">
                                    <h6 class="fs-16 font-w600 mb-0"><a href="invoices.html" class="text-black" style="text-decoration: none;">FSoziety</a>
                                    </h6>
                            ...
                            <div class="d-flex align-items-center pb-3 border-bottom mb-3">
                                <img src="../assets/10.png" alt="" class="rounded-circle me-3" width="50">
                                <div class="me-auto">
                                    <h6 class="fs-16 font-w600 mb-0"><a href="invoices.html" class="text-black" style="text-decoration: none;">David
                                            Ignis</a></h6>
                            ...
                            <div class="d-flex align-items-center pb-3 border-bottom mb-3">
                                <img src="../assets/10.png" alt="" class="rounded-circle me-3" width="50">
                                <div class="me-auto">
                                    <h6 class="fs-16 font-w600 mb-0"><a href="invoices.html" class="text-black" style="text-decoration: none;">Olivia
                                            Johan..</a></h6>
                                    <span class="fs-12">4h ago</span>
                                </div>
                            ...
                            <div class="d-flex align-items-center pb-3 border-bottom mb-3">
                                <img src="../assets/10.png" alt="" class="rounded-circle me-3" width="50">
                                <div class="me-auto">
                                    <h6 class="fs-16 font-w600 mb-0"><a href="invoices.html" class="text-black" style="text-decoration: none;">Stevan
                                            Store</a></h6>
                                    <span class="fs-12">4h ago</span>
                                </div>
                            ...
                            <div class="d-flex align-items-center">
                                <img src="../assets/10.png" alt="" class="rounded-circle me-3" width="50">
                                <div class="me-auto">
                                    <h6 class="fs-16 font-w600 mb-0"><a href="invoices.html" class="text-black" style="text-decoration: none;">Kidz Zoo</a>
                                    </h6>
                                    <span class="fs-12">4h ago</span>
                                </div>
