                    ...
                    <div class="card-header d-sm-flex d-block border-0 pb-0">
                        <div class="mb-sm-0 mb-2">
                            ...
                            <span class="mb-0">
                                ...
                                <strong class="fs-24 text-black ms-2 me-3">43%</strong>Than last week</span>
                        </div>
                        <span class="fs-12">
                            <svg width="21" height="15" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
                                ...
                                <defs>
                                    <linearGradient id="paint0_linear2" x1="10.2499" y1="3" x2="10.9999" y2="13.5"
                                        gradientUnits="userSpaceOnUse">
                                        <stop offset="0" stop-color="#2BC155" stop-opacity="0.73" />
                                        <stop offset="1" stop-color="#2BC155" stop-opacity="0" />
                                    </linearGradient>
                            ...
                            <div class="col-xl-5 col-xxl-12 col-md-5">
                                ...
                                <div class="row">
                                    <div class="d-flex col-xl-12 col-xxl-6  col-md-12 col-sm-6 mb-4">
                                        <svg class="me-3" width="14" height="54" viewBox="0 0 14 54" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="table-responsive">
                                <table class="table table-responsive-md card-table previous-transactions">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="fs-16 text-black font-w400 mb-0">June 4, 2023</h6>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="fs-16 text-black font-w400 mb-0">June 5, 2023</h6>
                                            <span class="fs-14">05:34</span>
                                        </td>
