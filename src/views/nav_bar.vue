                            ...
                            <div class="dashboard_bar" >
								<div class="input-group search-area d-lg-inline-flex d-none" >
									<div class="input-group-append" >
										<button class="input-group-text search_icon" ><i class="flaticon-381-search-2"></i></button>
									</div>
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="#" role="button" data-bs-toggle="dropdown">
									...
									<span class="badge light text-white bg-primary rounded-circle"  style="background-color: #1EAAE7 !important; outline: none; border: none;">12</span>
                                </a>
											...
											<li>
												<div class="timeline-panel">
													<div class="media me-2">
														<img alt="image" width="50" src="./1.jpg">
													</div>
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link bell bell-link" href="#" >
									...
									<span class="badge light text-white bg-primary rounded-circle"  style="background-color: #1EAAE7 !important; outline: none; border: none;">5</span>
                                </a>
							</li>
