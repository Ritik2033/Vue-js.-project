  ...
  <div id="main-wrapper">
    <div class="nav-header">
      <a href="index.html" class="brand-logo">
        <!--<img class="logo-abbr" src="./logo.png" alt="" height="80px" width="200px" style="background-color: transparent;">-->
      ...
      <div class="nav-control" >
        <div class="hamburger" >
          <button @click="toggleSidebar"><span class="line"></span><span class="line"></span><span class="line"></span></button>
        </div>
      </div>
    </div>
              ...
              <div class="dashboard_bar">
                <div class="input-group search-area d-lg-inline-flex d-none">
                  <div class="input-group-append">
                    <button class="input-group-text search_icon"><v-icon class="search_icon">flaticon-381-search-2</v-icon></button>
                  </div>
