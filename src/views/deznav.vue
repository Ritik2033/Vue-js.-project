<template>
    <div class="content-body" style=" margin-top: 5rem; background: #EFEFEF !important; margin-left: 0rem !important;">
        <!-- row -->
                    ...
                    <div class="col-sm-6 p-0">
                        ...
                        <div class="col-sm-6 p-0 justify-content-sm-start mt-2 mt-sm-0 d-flex">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="javascript:void(0)">#{{ list.cif }}</a></li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card">
                                    <div class="card-header d-sm-flex d-block border-0 pb-0">
                                        <div class="me-auto mb-sm-0 mb-3">
                                            ...
                                            <span class="fs-34 text-black font-w600">#{{ list.cif }}</span>
                                        </div>
                                        <div>
                                            <a href="javascript:void(0)"
                                                class="btn btn-outline-primary btn-rounded me-3 mb-sm-0 mb-2"><i
                                                    class="las la-print me-3 scale5"></i>Print</a>
                                            <a href="javascript:void(0)" class="btn btn-primary btn-rounded mb-sm-0 mb-2"  style="background-color: #1EAAE7 ; outline: none; border: none;"><i
                                    ...
                                    <div class="card-body border-bottom">
                                        <div class="d-flex flex-wrap mb-sm-2 justify-content-between">
                                            <div class="pr-3 mb-3">
                                                ...
                                                <span class="text-black fs-18 font-w500">{{ list.loanPunished }}</span>
                                            </div>
                                            <div class="pr-3 mb-3">
                                                <p class="fs-14 mb-1">Invoice Date</p>
                                                <span class="text-black fs-18 font-w500">{{ list.FechaUltimoCorte }}</span>
                                            </div>
                                            <div class="pr-3 mb-3">
                                        ...
                                        <div class="p-3 bgl-dark rounded fs-14 d-flex">
                                            <svg class="me-3 min-w24" width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-sm-flex d-block">
                                            <div class="d-flex me-auto mb-sm-0 mb-3 align-items-center">
                                                <img src="./30.png" alt="" class="me-3 rounded-circle" width="85">
                                                <div>
                                                    <h3 class="fs-24 text-black font-w600">{{ list.ms }}</h3>
                                                    <span>{{ list.ms }}@example.com</span>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center p-3 rounded border border-primary">
                                                <svg class="me-3" width="49" height="49" viewBox="0 0 49 49" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                                ...
                                                <div>
                                                    ...
                                                    <span class="text-primary font-w600">+91 123-456-7890</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-lg-6 col-md-12 mb-5">
                                <div class="card-bx mb-0">
                                    <img src="./card1.png" alt="" class="w-100">
                                    <div class="card-info text-white">
                                        <p class="mb-1">Main Balance</p>
                                        <h2 class="fs-36 text-white mb-sm-4 mb-3">${{ list.accountCurrentBalance }}</h2>
                                        <div class="d-flex align-items-center justify-content-between mb-sm-5 mb-3">
                                            <img src="./dual-dot.png" alt="" class="dot-img">
...
import data from '../views/t_d.json';
//import VueApexCharts from 'vue-apexcharts'; // Import the wrapper
//import "apexcharts/dist/apexcharts.css"; // Import the styles
...
export default {
            ...
            chartOptions: {
               ...
               labels: ['#1EAAE7', 'White'],
                ...
                plotOptions: {
                    pie: {
                        donut: {
                            size: '65%' // Adjust the size of the donut hole here
                        }
                    }
                },
                responsive: [{
    ...
    methods: {
        fetchData() {
            console.log(data);
            //console.log("listaCuenta:",data.list_transaction[0].transaccion); 
            this.list = data;
            /*axios.get('../viees/data.json')
              .then(response => {
                console.log("Full API Response:", response.data);
                //console.log("listaCuenta:", response.data.listaCuenta); 
                //console.log("cuentas:", response.data.listaCuenta[0].cuentas); 
                //this.list = response.data.listaCuenta[0].cuentas;
              })
              .catch(error => {
