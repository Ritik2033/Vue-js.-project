				...
				<div class="login-form">
					<div class="login-head">
						...
						<p style="color: #708090 !important; ">Login page allows users to enter login credentials for
							authentication and access to secure content.</p>
					</div>
					...
					<form action="index.html" @submit.prevent="submit">
						<div class="mb-4">
							<label class="mb-1 text-black">Username</label>
							<input type="text" class="form-control" value="Username" v-model="username" name="username">
							<p class="error" style="color: red;">{{ validationErrors.username }}</p>
						</div>
						<div class="mb-4">
							...
							<div class="mb-4">
								<div class="form-check custom-checkbox mb-3">
									...
									<label class="form-check-label" for="customCheckBox1"
										style="color: #708090 !important; ">Already have an account?</label>
								</div>
							</div>
							<div class="mb-4">
						...
						<div class="text-center mb-4">
							<button type="submit" class="btn btn-primary btn-block"
								style="background-color: #1EAAE7; border: #1EAAE7;">Sign me up</button>
						</div>
...
export default {
	...
	methods: {
		async submit() {
			...
			if (!this.validationErrors.username && !this.validationErrors.email && !this.validationErrors.password) {
...
.btn btn-outline-black d-block apple social-btn:hover{
