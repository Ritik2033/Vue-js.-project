	...
	<div class="login-account">
		<div class="row h-100">
			<div class="col-lg-6 align-self-start">
				<div class="account-info-area" style="background-image: url(./rainbow.gif); ">
					<div class="login-content">
						...
						<p class="text" style="font-weight: 400 !important; ">Lorem ipsum dolor sit amet, consectetur
			...
			<div class="col-lg-6 col-md-7 col-sm-12 mx-auto align-self-center">
				<div class="login-form">
					<div class="login-head">
						<h3 class="title" style="color: rgb(14, 13, 13) !important;">Welcome Back</h3>
						<p style="color: #708090 !important; ">Login page allows users to enter login credentials for
							authentication and access to secure
							content.</p>
					</div>
					...
					<div class="row mb-5">
						...
						<div class="col-xl-6 col-sm-6">
							<a href="javascript:void(0);" class="btn btn-outline-black d-block apple social-btn"
								style="border: 1px solid !important; border-radius: 5px !important; cursor: pointer;">
					...
					<form action="index.html" @submit.prevent="login">
						<div class="mb-4">
							<label class="mb-1 text-black">Email</label>
							<input type="email" class="form-control" value="hello@example.com" v-model="email" name="email">
							<p class="error" style="color: red;">{{ validationErrors.email }}</p>
						</div>
						<div class="mb-4">
							<label class="mb-1 text-black">Password</label>
							<input type="password" class="form-control" value="Password" v-model="password" name="password">
							<p class="error" style="color: red;">{{ validationErrors.password }}</p>
						</div>
							...
							<div class="mb-4">
								<div class="form-check custom-checkbox mb-3">
									...
									<label class="form-check-label" for="customCheckBox1"
										style="color: #708090 !important; ">Remember my preference</label>
								</div>
							</div>
							<div class="mb-4">
								<a href="page-forgot-password.html" class="btn-link text-primary"
									style="text-decoration: none; color: #1EAAE7 !important; font-size: 16px;">Forgot
									Password?</a>
							</div>
						</div>
						<div class="text-center mb-4">
							<button type="submit" class="btn btn-primary btn-block"
								style="background-color: #1EAAE7; border: #1EAAE7;">Sign Me In</button>
						</div>
						<p class="text-center" style="font-weight: 400 !important; color: #708090 !important;">Not
							registered?
							<a class="btn-link text-primary" href="page-register.html"
								style="text-decoration: none; color: #1EAAE7 !important ; font-size: 16px;"
								@click.prevent="Register">Register</a>
						</p>
					</form>
				</div>
			</div>
...
.account-info-area {
	background-image: url('./rainbow.gif') !important;
}
</style>